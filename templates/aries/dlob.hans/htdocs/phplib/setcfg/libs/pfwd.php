...
function pfwd_setcfg($prefix, $nat, $svc)
{
	...
	foreach ($src_base)
	{
		...
		set($pfwd_base."/entry:".$InDeX."/inbfilter",		query("inbfilter")		);		
		set($pfwd_base."/entry:".$InDeX."/description",		query("description")	);
		set($pfwd_base."/entry:".$InDeX."/protocol",		query("protocol")		);
		set($pfwd_base."/entry:".$InDeX."/protocolnum",		query("protocolnum")	);
		...
		{set($pfwd_base."/entry:".$InDeX."/wakeonlan_mac",	query("wakeonlan_mac")	);}
	}

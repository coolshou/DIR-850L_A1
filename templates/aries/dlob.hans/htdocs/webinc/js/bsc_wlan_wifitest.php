...
Page.prototype =
{
	//services: "WIFI.BAND24G-1.1,RUNTIME.PHYINF.BAND24G-1.1",
	//services: "WIFI.BAND24G-1.1,RUNTIME.PHYINF.BAND24G-1.1,WIFI.WLAN-2,RUNTIME.PHYINF.WLAN-2",
	...
	{
		PXML.doc = xml;
		//if(!this.Initial("WIFI.BAND24G-1.1", "RUNTIME.PHYINF.BAND24G-1.1")) return false; 
		//if(!this.Initial("WIFI.WLAN-2", "RUNTIME.PHYINF.WLAN-2")) return false;
		if(!this.Initial("BAND24G-1.1","WIFI.PHYINF","RUNTIME.PHYINF")) return false; 
	...
	PreSubmit: function()
	{
		if(!this.SaveXML("BAND24G-1.1","WIFI.PHYINF","RUNTIME.PHYINF")) return null; 

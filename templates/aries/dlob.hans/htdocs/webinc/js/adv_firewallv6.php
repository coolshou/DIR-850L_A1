...
Page.prototype =
{
	services: "FIREWALL6, IP6TSMPSECURITY",
	OnLoad: function()
	{
		if (!this.rgmode)
		{
	...
	{
		PXML.doc = xml;
		var smp_security = PXML.FindModule("IP6TSMPSECURITY");
		
		OBJ("smp_security").checked = (XG(smp_security+"/device/simple_security")==="1");
	...
	{
		var smp_security = PXML.FindModule("IP6TSMPSECURITY");
		XS(smp_security+"/device/simple_security",	OBJ("smp_security").checked ? "1":"0");

...
<div class="blackbox">
	...
	if(query("/device/gw_name")=="DIR-865L" && query("/device/layout")=="bridge")
	{$DISABLE_IPV6_PING = "1";}
	else {$DISABLE_IPV6_PING = "0";}
?>
<div class="blackbox"<?if($FEATURE_NOIPV6=="1" || $DISABLE_IPV6_PING=="1")echo ' style="display:none"';?>>

...
<div class="orangebox">
	...
	<p><?echo i18n("This option is used to open multiple ports or a range of ports in your router and redirect data through those ports to a single PC on your network.")." ".
		i18n("This feature allows you to enter ports in the format, Port Ranges (100-150), Individual Ports (80, 68, 888), or Mixed (1020-5000, 689).")." ".
...
<div class="blackbox">
	...
	<div class="centerline" align="center">
		...
		<tr>
			...
			<th width="136px">&nbsp;</th>
			<th width="162px">&nbsp;</th>
			<th width="105px"><?echo i18n("Ports to Open");?></th>
			<?if ($FEATURE_NOSCH!="1"){echo '<th width="83px">&nbsp;</th>\n';}?>
		</tr>
<?
$INDEX = 1;

...
<div class="blackbox">
	<h2><?echo i18n("Manual IPV6 LOCAL CONNECTIVITY SETUP");?></h2>
	<p><?echo i18n("If you would like to configure the IPv6 local connectivity settings of your D-Link Router, then click on the button below.");?></p>
	<div class="centerline">
		<input type="button" id="ulasetup" value="<?echo i18n("IPv6 Local Connectivity Settings");?>" onClick='self.location.href="bsc_ipv6_ula.php";' usrmode="enable" />
	</div>
	<div class="emptyline"></div>
</div>
<div class="blackbox">
	<h2><?echo i18n("Manual IPV6 INTERNET CONNECTION SETUP");?></h2>

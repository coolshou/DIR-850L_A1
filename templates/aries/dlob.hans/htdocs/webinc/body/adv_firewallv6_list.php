		<tr>
			...
			<td class="left" colspan="2" width="160px">
				<?echo i18n("Name");?><br>
				<input id="dsc_<?=$INDEX?>" type="text" style="width:150px" maxlength="31" />
			</td>
		...
		<tr>
			...
			<input id=src_startip_<?=$INDEX?> type="text" maxlangth="35" style="width:193px"/>-
			<input id=src_endip_<?=$INDEX?> type="text" maxlangth="35" style="width:193px"/>
			</td>
			</td>
			<td class="left">
		...
		<tr>
			...
			<td>
			<?echo i18n("IP Address Range");?><br>
			<input id=dst_startip_<?=$INDEX?> type="text" maxlangth="35" style="width:193px"/>-
			<input id=dst_endip_<?=$INDEX?> type="text" maxlangth="35" style="width:193px"/>
			</td>
			<td class="left">

...
<div class="blackbox">
	...
	<div class="textinput">
		...
		<span>
			<input type="button" value="<?echo i18n("Save Configuration");?>" onClick="PAGE.OnClickDownload();" />
		</span>
	</div>	
	</form>
	<br/>
	...
	<div class="textinput">
		...
		<span class="delimiter"></span>
		<span>
			<input type="button" value="<?echo i18n("Restore Configuration From File");?>" onClick="PAGE.OnClickUpload();" />
		</span>
	</div>
	</form>
	<br/>
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span>
			<input type="button" value="<?echo i18n("Restore Factory Defaults");?>" onClick="PAGE.OnClickFReset();" />
		</span>
	</div>
	</form>
	<br/>

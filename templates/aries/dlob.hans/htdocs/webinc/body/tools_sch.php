...
<div class="orangebox">
	...
	<p><?
		echo i18n('The Schedule configuration option is used to manage schedule rules for "WAN", "Wireless", "Virtual Server", "Port Forwarding", "Applications" and "Network Filter".');
	?></p>
</div>
<div class="blackbox">
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<select id="timeformat" onChange="PAGE.OnChangeTimeFormat(this.value)">
				<option value="12-hour"><?echo i18n("12-hour");?></option>
				<option value="24-hour"><?echo i18n("24-hour");?></option>
			</select>
		</span>
	</div>	
	<div class="textinput">

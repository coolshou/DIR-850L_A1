...
<!-- router/bridge mode or access point mdoe -->
<div class="blackbox" <?if ($FEATURE_NOAPMODE == "1" && $FEATURE_HAVEBGMODE=="0") echo 'style="display:none;"';?> >
	<h2><?
			if ($FEATURE_NOAPMODE == "0") {echo i18n("Access Point Mode");}
			else if ($FEATURE_HAVEBGMODE=="1") {echo i18n("Bridge Mode");}
			?>
	</h2>
		<p class="strong">
			<? 
			if ($FEATURE_NOAPMODE == "0") {echo i18n("Use this to disable NAT on the router and turn it into an Access Point.");}
			else if ($FEATURE_HAVEBGMODE=="1") {echo i18n("Use this to disable NAT on the router and turn it into an Bridge mode.");}
			?>
		</p>
		<p><input type="checkbox" id="rgmode" onclick="PAGE.OnClickRgmode('checkbox');" />
			<?
			if ($FEATURE_NOAPMODE == "0") {echo i18n("Enabled Access Point Mode");}
			else if ($FEATURE_HAVEBGMODE=="1") {echo i18n("Enabled Bridge Mode");}
			?>
		</p>
	<div class="gap"></div>
</div>
...
<div class="blackbox" id="ipv4_setting">
	...
	<div id="box_wan_ipv4_common_body">
		...
		<div class="textinput">
			...
			<span class="delimiter"></span>
			<span class="value"><input id="ipv4_mac_button" type="button" value="<?echo I18N("h","Clone Your PC's MAC Address");?>" onclick="PAGE.OnClickMacButton('ipv4_macaddr');" /></span>
		</div>
	</div>
	<div class="gap"></div>
	<!-- end common -->
...
if ($FEATURE_NOSCH=="1")	echo '</span>\n';
	...
	<div id="box_wan_ppp4_comm_body">
		...
		<div class="textinput">
			...
			<span class="delimiter"></span>
			<span class="value">
				<input id="mac_button" type="button" value="<?echo I18N("h","Clone Your PC's MAC Address");?>" onclick="PAGE.OnClickMacButton('ppp4_macaddr');" />
			</span>
		</div>
	</div>
	<div class="gap"></div>

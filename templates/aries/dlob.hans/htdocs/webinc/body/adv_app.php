...
<div class="blackbox">
	...
	<div class="centerline" align="center">
		...
		<tr>
			...
			<th width="101px">&nbsp;</th>
			<th width="165px">&nbsp;</th>
			<th width="60px"  style="text-align:center"><?echo i18n("Port");?></th>
			<th width="102px" style="text-align:center"><?echo i18n("Traffic Type");?></th>
			<th width="65px"  style="text-align:center"><?echo i18n("Schedule");?></th>
		</tr>
<?
$INDEX = 1;

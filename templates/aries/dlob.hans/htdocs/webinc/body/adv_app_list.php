<? include "/htdocs/webinc/body/draw_elements.php"; ?>		
		<tr>
			...
			<td rowspan="2" class="centered"><?echo i18n("Name");?><br /><input id="name_<?=$INDEX?>" type="text" size="13" maxlength="15" /></td>
			...
			<td class="centered"><?echo i18n("Trigger");?><br /><input id="priport_<?=$INDEX?>" type="text" size="6" maxlength="11" /></td>
		...
		<tr>
			<td class="centered"><?echo i18n("Firewall ");?><br /><input id="pubport_<?=$INDEX?>" type="text" size="6" maxlength="60" /></td>
			<td class="centered"><!--<?echo i18n("Protocol");?><br/>-->

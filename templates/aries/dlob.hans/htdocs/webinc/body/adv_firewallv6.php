...
<div class="blackbox">
	<h2><?echo i18n("IPv6 SIMPLE SECURITY");?></h2>
	<div class="textinput">
		<span class="name"><?echo i18n("Enable IPv6 Simple Security");?></span>
		<span class="delimiter">:</span>
		<span class="value"><input id="smp_security" type="checkbox"/></span>
	</div>
	<div class="gap"></div>
</div>

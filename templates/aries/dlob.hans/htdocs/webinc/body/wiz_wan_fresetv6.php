...
<div class="blackbox">
	...
	<div class="wiz-l2">
		<?echo i18n("Choose this option if your Internet Setup Provider (ISP) provided you with IPv6 Address information that has to be manually configured.");?>
	</div>
	<div class="wiz-l1">
	...
	<div class="wiz-l2">
		<?echo i18n("Choose this option if your Internet Setup Provider (ISP) provided you a IPv6 Internet Connection by using 6rd automatic tunneling mechanism.");?>
	</div>
	<? wiz_buttons();?>
</div>
</div>

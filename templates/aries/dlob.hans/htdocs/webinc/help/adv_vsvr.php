...
?></p>
<p>&nbsp;&#149;&nbsp;&nbsp;<?
	echo i18n("Select a filter that restricts the Internet hosts that can access this virtual server to hosts that you trust. If you do not see the filter you need in the list of filters, go to the <a href='/adv_inb_filter.php'>Advanced -> Inbound Filter</a> screen and create a new filter.");
?></p>
<p>&nbsp;&#149;&nbsp;&nbsp;<?

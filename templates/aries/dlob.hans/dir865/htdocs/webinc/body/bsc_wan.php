...
<div class="blackbox" <?if ($FEATURE_NOAPMODE == "1") echo 'style="display:none;"';?> >
	<h2><?echo i18n("Bridge Mode");?></h2>
		<p class="strong">
			<?echo i18n("Use this to disable NAT on the router and turn it into an Bridge mode.");?>
		</p>
		<p><input type="checkbox" id="rgmode" onclick="PAGE.OnClickRgmode('checkbox');" /><?echo i18n("Enabled Bridge Mode");?></p>
	<div class="gap"></div>
</div>
<!-- wan mode -->
<div class="blackbox">

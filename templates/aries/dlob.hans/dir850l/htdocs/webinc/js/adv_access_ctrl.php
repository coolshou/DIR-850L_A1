...
Page.prototype =
{
	services: "ACCESSCTRL, SCHEDULE, INET.LAN-1, HW_NAT",
	OnLoad: function() 
	{
		this.Dirty = false;
		if (!this.rgmode)
	...
	OnClickSchSelect: function(sch_uid)
	{
		...
		{
			OBJ("sch_detail").value = "<?echo I18N("j","always");?>"; //The schedule already had been deleted. 
			OBJ("sch_select").value = "always";//==20130122 jack move for fix CN error==//
		}

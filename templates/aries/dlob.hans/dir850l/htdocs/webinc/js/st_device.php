...
?>		
	...
	InitWLAN: function ( wlan_phyinf, wifi_phyinf )
	{
		...
		//==20130118 jack :at first, the /media/channel will show "-1", if channel = -1, then show N/A"==//
		if(host_channel == "-1")
			OBJ("st_Channel"+str_Aband).innerHTML  = "N/A";
		else
	...
	InitWAN: function ()
	{
		...
		//==20130123 jack fix str miss-match error, can't use CN to compare with EN==//

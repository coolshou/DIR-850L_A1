	...
	<div class="textinput">
		...
		<span class="value">
			<select id="wlan_mode" onChange="PAGE.OnChangeWLMode('');">
				<!--<option value="b" style="display:none">802.11b only</option>-->
...
<div id="div_5G" style="display:none;">
		...
		<div class="textinput">
			...
			<span class="value">
				<select id="wlan_mode_Aband" onChange="PAGE.OnChangeWLMode('_Aband');">
					<option value="n">802.11n only</option>
					<option value="ac_only">802.11ac only</option>
					<option value="an">Mixed 802.11a and 802.11n</option>
					<option value="acn">Mixed 802.11ac and 802.11n</option>
					<option value="ac">Mixed 802.11ac, 802.11n and 802.11a</option>
				</select>
			</span>
		</div>
	...
	?>			</select>
		...
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value">
				<input type="radio" class="name" id="ssid_visible_Aband" 	name="invisible_type_Aband" value="visible"  />  <label><?echo i18n("Visible");?></label>
		        <input type="radio" class="name" id="ssid_invisible_Aband" 	name="invisible_type_Aband" value="invisible" /> <label><?echo i18n("Invisible");?></label>
			</span>
		</div>
		<div class="textinput" style="display:none;">
			<span class="name"><?echo i18n("WMM Enable");?></span>

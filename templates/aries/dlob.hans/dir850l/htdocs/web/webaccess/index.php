...
<html>
	...
	<body onLoad="get_system_info()">
   	<div id="outside_1col">
            	...
            	<td>
               	<div id="header_container">
                  	<div id="info_bar">
						...
						<div class="hwv"><? echo I18N("h", "Hardware Version");?> : <? $hwver=query("/runtime/device/hardwareversion");  if ($hwver=="1A1G") $hwver="A1"; echo $hwver; ?><span id="hw_ver" align="left"></span></div>
      	...
      	<div id="copyright">Copyright &copy; 2013 D-Link Corporation. All rights reserved.</div>
    	</div>
	</body>
</html>

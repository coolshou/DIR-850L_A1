...
<!-- ===================== WDS ============================== -->
<div id="div_WDS" class="blackbox" style="display:none;">
	<h2><?echo i18n("WDS Settings");?></h2>
	<div class="textinput">
		<span class="name"><?echo i18n("Enable WDS");?></span>
		<span class="delimiter">:</span>
		<span class="value">
		<input id="en_wifi_WDS" type="checkbox" onClick="PAGE.OnClickEnWDS('');" />
			<?
			if ($FEATURE_NOSCH!="1")
			{
				DRAW_select_sch("sch_WDS", i18n("Always"), "", "", "0", "narrow");
				echo '<input id="go2sch_WDS" type="button" value="'.i18n("New Schedule").'" onClick="javascript:self.location.href=\'./tools_sch.php\';" />\n';
			}
			?>
		</span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Wi-Fi Network Name");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="ssid_WDS" type="text" size="20" maxlength="32" />
            <input id="site_survey" type="button" value="<?echo i18n("Site Survey");?>" onClick="PAGE.OnClickSiteSurvey('');" />
		</span>
	</div>
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<select id="security_type_WDS" onChange="PAGE.OnChangeSecurityType('_WDS');">
...
<div id="wep_WDS" class="blackbox" style="display:none;">
	<h2><?echo i18n("WEP");?></h2>
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<select id="wep_key_len_WDS" onChange="PAGE.OnChangeWEPKey('_WDS');">
				<option value="64"><?echo i18n("64 bit (10 hex digits)");?></option>
				<option value="128"><?echo i18n("128 bit (26 hex digits)");?></option>
			</select>
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<select id="auth_type_WDS" onChange="PAGE.OnChangeWEPAuth('_WDS');">
				<!--<option value="OPEN"><?echo i18n("Open");?></option>-->
				<option value="WEPAUTO"><?echo i18n("Both");?></option>
	...
	<div class="textinput" style="display:none;">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<select id="wep_def_key_WDS" onChange="PAGE.OnChangeWEPKey('_WDS');">
				<option value="1"><?echo i18n("WEP Key 1");?></option>
				<option value="2"><?echo i18n("WEP Key 2");?></option>
				<option value="3"><?echo i18n("WEP Key 3");?></option>
				<option value="4"><?echo i18n("WEP Key 4");?></option>
			</select>
		</span>
	</div>
	<div id="wep_64_WDS" class="textinput">
		<span class="name"><?echo i18n("WEP Key 1");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="wep_64_1_WDS" name="wepkey_64_WDS" type="text" size="15" maxlength="10" />
			<input id="wep_64_2_WDS" name="wepkey_64_WDS" type="text" size="15" maxlength="10" />
			<input id="wep_64_3_WDS" name="wepkey_64_WDS" type="text" size="15" maxlength="10" />
			<input id="wep_64_4_WDS" name="wepkey_64_WDS" type="text" size="15" maxlength="10" />
		</span>
	</div>
	<div id="wep_128_WDS" class="textinput">
		<span class="name"><?echo i18n("WEP Key 1");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="wep_128_1_WDS" name="wepkey_128_WDS" type="text" size="31" maxlength="26" />
			<input id="wep_128_2_WDS" name="wepkey_128_WDS" type="text" size="31" maxlength="26" />
			<input id="wep_128_3_WDS" name="wepkey_128_WDS" type="text" size="31" maxlength="26" />
			<input id="wep_128_4_WDS" name="wepkey_128_WDS" type="text" size="31" maxlength="26" />
		</span>
	</div>
...
<div id="box_wpa_WDS" class="blackbox" style="display:none;">
	<h2><?echo i18n("WPA");?></h2>
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<select id="wpa_mode_WDS" onChange="PAGE.OnChangeWPAMode('_WDS');">
<!--				<option value="WPA+2"><?echo i18n("Auto(WPA or WPA2)");?></option> -->
				<option value="WPA2"><?echo i18n("Auto(WPA2 Only)");?></option>
...
<div id="box_wpa_personal_WDS" class="blackbox" style="display:none;">
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="wpa_psk_key_WDS" type="text" size="20" maxlength="64" />
		</span>
	</div>
<div id="box_wpa_enterprise_WDS" class="blackbox" style="display:none;">
<!-- NULL block -->
</div>
	<div class="gap"></div>
	<div class="gap"></div>	
...
<div id="div_24G" class="blackbox">
	<h2 id="div_24G_title"><?echo i18n("Wireless Network Settings");?></h2>
	<div id="div_24G_wlband" class="textinput">
		<span class="name"><?echo i18n("Wireless Band");?></span>
		<span class="delimiter">:</span>
		<span class="value"><b><?echo i18n("2.4GHz Band");?></b></span>
	</div>
	<div id="div_24G_enwlan" class="textinput">
	...
	<div id="div_24G_extssid" style="display:none;">
	<div class="textinput">
		<span class="name"><?echo i18n("Extend SSID");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input type="radio" id="ssid_Remain" name="ssid_ext" onClick="PAGE.OnClickExtssid();" />
			<?echo i18n("Remain the same as SSID");?>
		</span>
	</div>
	<div class="textinput">
		...
		<span class="delimiter"></span>
		<span class="value">
			<input type="radio" id="ssid_Create"  name="ssid_ext" onClick="PAGE.OnClickExtssid();" />
			<?echo i18n("Create Extended SSID");?>
		</span>
	</div>
	</div>
	<div id="div_24G_wlan" class="textinput">
		<span class="name" id="wlan24G_ssidname"><?echo i18n("Wireless Network Name");?></span>
		<span class="delimiter" id="wlan24G_ssiddelimiter">:</span>
		<span class="value">
			<input id="ssid" type="text" size="20" maxlength="32" />
			(<?echo i18n("Also called the SSID");?>)
		</span>
	</div>
	<div id="div_24G_wlmode" class="textinput">
		<span class="name"><?echo i18n("802.11 Mode");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<select id="wlan_mode" onChange="PAGE.OnChangeWLMode('');">
				<option value="b"><?echo i18n("802.11b only");?></option>
                <option value="g"><?echo i18n("802.11g only");?></option>
				<option value="n"><?echo i18n("802.11n only");?></option>
				<option value="bg"><?echo i18n("Mixed 802.11g and 802.11b");?></option>
                <option value="gn"><?echo i18n("Mixed 802.11n and 802.11g");?></option>
				<option value="bgn"><?echo i18n("Mixed 802.11n, 802.11g and 802.11b");?></option>
			</select>
		</span>
	</div>	
	
	<div id="div_24G_autoch" class="textinput">
	...
	<div id="div_24G_channel" class="textinput">
...
?>			</select>
	...
	<div id="div_24G_txrate" class="textinput">
	...
	<div id="div_24G_bw" class="textinput">
	...
	<div id="div_24G_visibility" class="textinput">
...
<div class="blackbox">
	<h2 id="div_security_title"><?echo i18n("Wireless Security Mode");?></h2>
	<div class="textinput">
...
<div id="box_wpa" class="blackbox" style="display:none;">
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="wpa_grp_key_intrv" type="text" size="20" maxlength="10" /><?echo i18n("(seconds)");?> 
		</span>
	</div>	
	<div class="gap"></div>
</div>

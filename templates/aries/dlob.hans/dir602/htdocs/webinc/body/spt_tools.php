<div class="orangebox">
	...
	<ul>
		<li id="tools_admin_menu"><a href="./spt_tools.php#Admin"><?echo i18n("Admin");?></a></li>
...
<div class="blackbox" id="tools_admin">
	...
	<dl>
		<dt><?echo i18n("Admin password");?></dt>
		<dd><?
...
<div class="blackbox" id="tools_time">
	...
	<dl>
		...
		?></dd>
		<dt><?echo i18n("Automatic Time and Date Configuration");?></dt>
		<dd><?
		...
		?></dd>
		<dt><?echo i18n("Set the Time and Date Manually");?></dt>
		<dd><?
			echo i18n("Select this option if you would like to specify the time manually. You must specify the Year, Month, Day, Hour, Minute, and Second, or you can click the Sync. Your Computer's Time Settings button to copy the system time from the computer being used to access the management interface.");
		?></dd>
	</dl>
</div>
...
<div class="blackbox" id="tools_system">
	...
	?></p>
	<dl>
		<dt><?echo i18n("Save Configuration");?></dt>
		<dd><?
			echo i18n("Click this button to save the configuration file from the router.");
		?></dd>
		<dt><?echo i18n("Browse");?></dt>
		<dd><?
			echo i18n("Click Browse to locate a saved configuration file and then click Upload Configuration to Load to apply these saved settings to the router.");
		?></dd>
		<dt><?echo i18n("Restore To Factory Default Settings");?></dt>
		<dd><?
			echo i18n("This option restores all configuration settings back to the settings that were in effect at the time the router was shipped from the factory. Any settings that have not been saved will be lost. If you want to save your router configuration settings, use the Save Configuration option above.");
		?></dd>

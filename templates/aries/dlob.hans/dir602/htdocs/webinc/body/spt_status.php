<div class="orangebox">
	...
	<!--
		<li><a href="#Routing"><?echo i18n("Routing");?></a></li>
	-->
...
<div class="blackbox">
	...
	<dl>
		...
		<dd><?
			echo i18n("This displays the MAC Address of the WAN interface, as well as the IP Address, Subnet Mask, Default Gateway, and DNS server information that the router has obtained from your ISP. It will also display the connection type (Dynamic, Static, PPPoE,PPTP or L2TP) that is used establish a connection with your ISP. If the router is configured for Dynamic, then there will be buttons for releasing and renewing the IP Address assigned to the WAN interface. If the router is configured for PPPoE, there will be buttons for connecting and disconnecting the PPPoE session. If the router is configured for PPTP, there will be buttons for connecting and disconnecting the PPTP session. If the router is configured for L2TP, there will be buttons for connecting and disconnecting the L2TP session. ");
		?></dd>

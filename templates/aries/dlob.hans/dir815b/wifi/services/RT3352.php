...
while ($i>0)
{
	...
	else
	{
		...
		//	startcmd("ip link set ".$dev." up");
			...
			/* +++ upwifistats */
			startcmd("xmldbc -P /etc/services/WIFI/updatewifistats.php -V PHY_UID=".$uid." > /var/run/restart_upwifistats_24g.sh;");
			startcmd("phpsh /var/run/restart_upwifistats_24g.sh");
			/* --- upwifistats */

...
<div class="blackbox">
	...
	<ul>
		...
		<li><a href="./spt_adv.php#AccessCtrl"><?echo i18n("Access Control");?></a></li>
		<li><a href="./spt_adv.php#WebFilter"><?echo i18n("Website Filter");?></a></li>
		<li><a href="./spt_adv.php#InboundFilter"><?echo i18n("Inbound Filter");?></a></li>
...
<div class="blackbox">
	...
	<ul>
		...
		<li><a href="./spt_tools.php#Syslog"><?echo i18n("Syslog");?></a></li>		

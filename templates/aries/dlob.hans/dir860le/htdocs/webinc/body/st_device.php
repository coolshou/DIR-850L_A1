...
<div class="blackbox">
	...
	<!--
	<div class="textinput">
		<span class="name"><?echo i18n("WDS Status");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="st_WDS"></span>
	</div>
	-->
	<div class="gap"></div>
...
<div class="blackbox" id="wlan2" style="display:none">
	...
	<div class="textinput">
		<span class="name"><?echo i18n("MAC Address");?></span>
		<span class="delimiter">:</span>
		<span class="value"><?echo query("/runtime/devdata/wlan5mac");?></span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("802.11 Mode");?></span>
		<span class="delimiter">:</span>
...
<div class="blackbox">
	...
	<table id="igmp_groups" class="general" width="535px">
			<tr>			
				<th width="270px"><?if ($FEATURE_NOIPV6 =="0") {echo i18n("IPv4 Multicast Group Address");} else {echo i18n(" Multicast Group Address");}?></th>
			</tr>
	</table>	

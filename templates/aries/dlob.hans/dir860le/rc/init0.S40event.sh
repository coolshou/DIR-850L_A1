...
event WAN-1.UP		insert "HWNAT:service HW_NAT restart"
event WAN-1.DOWN	add "service INFSVCS.WAN-1 stop"
event WAN-1.DOWN	insert "HWNAT:service HW_NAT stop"
event WAN-2.UP		add "service INFSVCS.WAN-2 restart"
event WAN-2.UP		insert "HWNAT:service HW_NAT restart"
event WAN-2.DOWN	add "service INFSVCS.WAN-2 stop"
event WAN-2.DOWN	insert "HWNAT:service HW_NAT stop"

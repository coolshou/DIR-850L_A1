...
function check_portt_config($prefix, $nat)
{
	...
	foreach($base."/entry")
	{
		...
		{
			set_result("FAILED",$base."/entry:".$InDeX."/trigger/start",i18n("Invalid trigger port range.")
						." ".i18n("Wrong value."));
			$rlt = "-1";
			break;
		}
		if (isdigit($pt_end)=="0")
		{
			set_result("FAILED",$base."/entry:".$InDeX."/trigger/end",i18n("Invalid trigger port range.")
						." ".i18n("Wrong value."));
			$rlt = "-1";
			break;
		}
		...
		{
			set_result("FAILED",$base."/entry:".$InDeX."/trigger/start",i18n("Invalid trigger port range.")
						." ".i18n("Port range out of boundary."));
			$rlt = "-1";
			break;
		}
		...
		if ($pt_list=="")
		{
			set_result("FAILED",$base."/entry:".$InDeX."/external/portlist",i18n("Please enter firewall port range."));
			$rlt = "-1";
			break;
		}
		...
		while ($idx < $cnt)
		{
			...
			{
				set_result("FAILED",$base."/entry:".$InDeX."/external/portlist",i18n("Invalid firewall port range."));
				$rlt = "-1";
				break;
			}
			$idx++;

...
else
{
	foreach ($FATLADY_prefix."/acl/inbfilter/entry")
	{
		...
		foreach ($FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry")
		{
			...
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/startip:".query("seq"),i18n("The start IP address cannot be in the LAN network."));
				$rlt = "-1";
				break;
			}
			...
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/endip:".query("seq"),i18n("The end IP address cannot be in LAN network."));
				$rlt = "-1";
				break;
			}			

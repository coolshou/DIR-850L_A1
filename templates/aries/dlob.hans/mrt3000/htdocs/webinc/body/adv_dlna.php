	...
	<div id="content" class="maincolumn">
		...
		<div class="rc_gradient_bd h_parental">
			<h4><?echo I18N("h","DLNA");?></h4>
			<div class="gradient_form_content">
				<p><?echo I18N("h","You can share video/audio/image files stored on the hard disk drive.");?></p>
				<p class="assistant"><?echo I18N("h","DLNA Server");?></p>
				<p class="dent_i">
					<input type="radio" name="dms_active" id="inactive" value="0" onclick="PAGE.check_dms_enable(1);" />
					<label for="inactive"><?echo I18N("h","Disable");?></label>
				</p>
				<p class="dent_i">
					<input type="radio" name="dms_active" id="active" value="1" onclick="PAGE.check_dms_enable(1);" />
					...
					<span class="dent_i" style="display:none;">
						<input type="checkbox" id="dms_root" value="ON" onClick="PAGE.check_path(1);" />
						<label for="dms_root"><?echo I18N("h","Start from root folder");?></label><br />
						<span id="chamber2">

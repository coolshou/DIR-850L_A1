...
{
	if		($uid=="BAND24G-1.1") return "rai0";
	else if ($uid=="BAND24G-1.2") return "rai1";
	return "rai0";
}
...
startcmd("insmod /lib/modules/RT3090_ap_util.ko");
startcmd("insmod /lib/modules/RT3090_ap.ko");
startcmd("insmod /lib/modules/RT3090_ap_net.ko");
startcmd("xmldbc -P /etc/services/WIFI/rtcfg.php -V PHY_UID=BAND24G-1.1 > /var/run/RT3090.dat");
...
stopcmd("rmmod RT3090_ap_net");
stopcmd("rmmod RT3090_ap");
stopcmd("rmmod RT3090_ap_util");

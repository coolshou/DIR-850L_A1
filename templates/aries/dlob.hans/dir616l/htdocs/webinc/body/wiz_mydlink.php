...
<div id="register_fill" class="blackbox" style="display:none;">
	...
	<div class="textinput">
		...
		<span class="value">
			<input id="email" type="text" size="20" maxlength="30" />
		</span>
	</div>
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="register_pwd" type="password" size="20" maxlength="30" />
		</span>
	</div>
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="register_pwd_confirm" type="password" size="20" maxlength="30" style="float:left;"/>
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="register_lastname" type="text" size="20" maxlength="30" />
		</span>
	</div>
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="register_firstname" type="text" size="20" maxlength="30" />
		</span>
	</div>
	<div class="textinput">
...
<div id="register_login" class="blackbox" style="display:none;">
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="email_login" type="text" size="20" maxlength="30" />
		</span>
	</div>
	<div class="textinput">
		<span class="name"><?echo i18n("Password");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="register_pwd_login" type="password" size="20" maxlength="30" />
		</span>
	</div>
	<div class="emptyline"></div>
	<div class="centerline">

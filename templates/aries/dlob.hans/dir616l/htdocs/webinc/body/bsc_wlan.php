...
?>			</select>
	...
	<div id="div_24G_visibility" class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input type="radio" class="name" id="ssid_visible" 		name="invisible_type" value="visible" 	onclick="PAGE.OnClickInvinsible('');" /> <label>Visible</label>
	        <input type="radio" class="name" id="ssid_invisible" 	name="invisible_type" value="invisible" onclick="PAGE.OnClickInvinsible('');" /> <label>Invisible</label>
		</span>
	</div>
	<div class="textinput" style="display:none;">

...
Page.prototype =
{
	...
	InitValue: function(xml)
	{
		...
		this.logType = "sysact";
		if(this.logType == "sysact")
		{
			OBJ("LOG_warn").disabled = true;
			OBJ("LOG_info").disabled = true;
			OBJ("LOG_dbg").disabled = true;
		}
		this.ReNewVars();
		this.DrawLog();
		return true;
	...
	ReNewVars:function()
	{
		...
		if(isint==this.logPages && this.logPages > 1)
		{
	...
	DrawLog:function()
	{
		...
		var str = "<p>"+ (this.pageInx + 1) + "/" + (1 + this.logPages) + "</p>";

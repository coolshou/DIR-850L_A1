...
Page.prototype =
{
	...
	InitValue: function(xml)
	{
		...
		if (!this.InitWLAN("BAND24G-1.3","WIFI.PHYINF")) return false;
...
?>		
	...
	InitWLAN: function ( wlan_phyinf, wifi_phyinf )
	{
		...
		opmode = XG(wifi_path+"/opmode");
		/*if(opmode == "APCLI")
		{
			OBJ("st_WDS").innerHTML  = XG(phy_wlan_path+"/active")== "1" ? "<?echo i18n("Enabled");?>":"<?echo i18n("Disabled");?>";
			return true;
		}*/
		if(freq=="5")
			str_Aband = "_Aband";

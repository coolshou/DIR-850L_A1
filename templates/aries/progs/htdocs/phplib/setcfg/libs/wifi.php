...
function phyinf_setcfg($prefix_phyinf)
{
	...
	$wifi_en_to = query($to."/active");
	$wifi_en_from = query("active");
	if($wifi_en_to == "1" && $wifi_en_from == "0" || $wifi_en_from == "" )
	{
		set("/runtime/wps/setting/PinErrorCount", 0);
		set("/runtime/wps/setting/aplocked", 0);
	}
...
function wifi_profile_setcfg($from, $to)
{
	...
	$wps_en_to = query($to."/wps/enable");
	$wps_en_from = query("wps/enable");
	if($wps_en_to == "1" && $wps_en_from == "0" || $wps_en_from == "")
	{
		set("/runtime/wps/setting/PinErrorCount", 0);
		set("/runtime/wps/setting/aplocked", 0);
	}

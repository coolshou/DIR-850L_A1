...
function check_ppp4($path)
{
	...
	if ($mtu != "")
	{
		...
		{
			if($FEATURE_NOIPV6==0) {set_result("FAILED",$path."/mtu",i18n("The MTU value is too large, the valid value for l2tp is 1280 ~ 1460."));}
		...
		else if ($mtu > 1492)
		{
            ...
            {
                if($FEATURE_NOIPV6==0) {set_result("FAILED",$path."/mtu",i18n("The MTU value is too large, the valid value is 1280 ~ 1492."));}

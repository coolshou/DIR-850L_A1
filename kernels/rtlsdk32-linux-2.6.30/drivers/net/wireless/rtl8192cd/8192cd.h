...
struct priv_shared_info {
	...
	unsigned char			tgpwr_CCK_8812[2];
	unsigned char			tgpwr_OFDM_8812[2];
	unsigned char			tgpwr_HT1S_8812[2];
	unsigned char			tgpwr_HT2S_8812[2];
	unsigned char			tgpwr_VHT1S_8812[2];
	unsigned char			tgpwr_VHT2S_8812[2];
#endif
#endif
...
struct timer_list			ps_timer;
	...
	/*Alpha +++*/
	unsigned int			all_available_chnl[76];		// all available channel for hidden page
	unsigned int			all_available_chnl_num;		// record the number
	/*Alpha +++*/

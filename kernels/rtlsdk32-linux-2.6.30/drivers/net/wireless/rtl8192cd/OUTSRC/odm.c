	...
	)
{
	...
	{ 
		if(pDM_Odm->SupportICType&(ODM_RTL8188E|ODM_RTL8723A|ODM_RTL8821))
			ODM_SetBBReg(pDM_Odm, 0xC50,0xff, CurrentIGI);
		else  //92S,92D,92C,88C,8812A,
		{	
			ODM_SetBBReg(pDM_Odm, 0xC50,0xff, CurrentIGI);
			ODM_SetBBReg(pDM_Odm, 0xC58,0xff, CurrentIGI);
		}
	}
	else if(pDM_Odm->SupportPlatform & (ODM_AP|ODM_ADSL))
	{
		...
		case ODM_CCA_1R_A:
			ODM_SetBBReg(pDM_Odm, 0xC50,0xff, CurrentIGI);
				if(pDM_Odm->SupportICType != ODM_RTL8188E)
				ODM_SetBBReg(pDM_Odm, 0xC58,0xff, getIGIForDiff(CurrentIGI));
			break;
		case ODM_CCA_1R_B:
			ODM_SetBBReg(pDM_Odm, 0xC50,0xff, getIGIForDiff(CurrentIGI));
				if(pDM_Odm->SupportICType != ODM_RTL8188E)
				ODM_SetBBReg(pDM_Odm, 0xC58,0xff, CurrentIGI);
				break;
		}

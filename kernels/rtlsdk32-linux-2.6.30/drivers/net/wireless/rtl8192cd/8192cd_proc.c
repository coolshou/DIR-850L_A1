...
//	if ((GET_CHIP_VER(priv)==VERSION_8192D) && (priv->pmib->dot11RFEntry.phyBandSelect & PHY_BAND_5G)) {
	...
	PRINT_SINGL_ARG("    txpwr_lmt_HT2S : ", (priv->pshare->txpwr_lmt_HT2S), "%d");
		...
		if(GET_CHIP_VER(priv)== VERSION_8812E){
			...
			PRINT_ARRAY_ARG("    tgpwr_CCK_8812 : ", (priv->pshare->tgpwr_CCK_8812), "%d ", 2);
			PRINT_ARRAY_ARG("    tgpwr_OFDM_8812 : ", (priv->pshare->tgpwr_OFDM_8812), "%d ", 2);
			PRINT_ARRAY_ARG("    tgpwr_HT1S_8812 : ", (priv->pshare->tgpwr_HT1S_8812), "%d ", 2);
			PRINT_ARRAY_ARG("    tgpwr_HT2S_8812 : ", (priv->pshare->tgpwr_HT2S_8812), "%d ", 2);
			PRINT_ARRAY_ARG("    tgpwr_VHT1S_8812 : ", (priv->pshare->tgpwr_VHT1S_8812), "%d ", 2);
			PRINT_ARRAY_ARG("    tgpwr_VHT2S_8812 : ", (priv->pshare->tgpwr_VHT2S_8812), "%d ", 2);
		} else
#endif
		{
...
#ifdef STA_EXT
	PRINT_SINGL_ARG("    fw_free_space:   ", priv->pshare->fw_free_space, "%d");
#endif
#ifdef CHECK_HANGUP

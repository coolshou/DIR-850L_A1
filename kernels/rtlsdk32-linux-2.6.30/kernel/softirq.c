...
/*
 * set softirq_restart to default 10 and not nice ksoftirqd
 * because when flooding attack. all resource are deal with
 * attack packets. so lan client can not access device UI.
 */

...
#define PACKAGE_BUILD_HOSTNAME "localhost"

/* Define to the command line used to invoke the configure script. */
#define PACKAGE_CONFIGURE_INVOCATION "./configure  '--build=i386-linux' '--host=mipsel-linux' 'CFLAGS=-Os -Wall -D__UCLIBC_HAS_MMU__ -D__UCLIBC__ -std=c99' 'build_alias=i386-linux' 'host_alias=mipsel-linux'"

...
/*Mapping channel id and frequency*/
  ...
  if(iw_get_range_info(skfd, ifname, &range) < 0)
      ...
      if(range.num_frequency > 0)
	{
	  ...
	  for(k = 0; k < range.num_frequency; k++)
	    {
	      freq = iw_freq2float(&(range.freq[k]));
		  MAP_KHZ_TO_CHANNEL_ID( (freq/1000000),chan );
		  if ((freq/1000000)>= 5150 && (freq/1000000) < 5250) {
		  	if (band != 1){
				if (band != -1) printf(" ");
				band = 1;
			}
		  ...
		  else if ((freq/1000000)>= 5250 && (freq/1000000) < 5350) {
		  	if (band != 2){
				if (band != -1) printf(" ");
				band = 2;
			}
		  ...
		  else if ((freq/1000000)>= 5470 && (freq/1000000) < 5725) {
		  	if (band != 3){
				if (band != -1) printf(" ");
				band = 3;
			}
		  ...
		  else if ((freq/1000000)>= 5725 && (freq/1000000) < 5850) {
		  	if (band != 4){
				if (band != -1) printf(" ");
				band = 4;
			}

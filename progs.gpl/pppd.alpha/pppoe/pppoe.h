...
* LIC: GPL
*
* $Id: pppoe.h,v 1.1.1.1 2005/05/19 10:53:06 r01122 Exp $
*
***********************************************************************/

#ifndef __PPPOE_HEADER_FILE__
#define __PPPOE_HEADER_FILE__
...
typedef int ParseFunc(UINT16_t type, UINT16_t len, unsigned char *data, void *extra);
...
int parseLogErrs(UINT16_t typ, UINT16_t len, unsigned char *data, void *xtra);
...
/* in pppoe_options.c */
extern int  pppoe_debug;
extern char pppoe_dev[];
extern char pppoe_srv_name[];
extern char pppoe_ac_name[];
extern int  pppoe_hostuniq;
extern int  pppoe_synchronous;
extern int  pppoe_mss;
...
#endif	/* end of #ifndef __PPPOE_HEADER_FILE__ */

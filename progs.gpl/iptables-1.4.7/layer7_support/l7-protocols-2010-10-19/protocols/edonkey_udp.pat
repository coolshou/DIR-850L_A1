...
# bouble- original pattern download from wiki
...
# bouble - for UDP connection, it's header will be {protocol, type }, it is difference with TCP - {protocol, length, type }
# bouble- base on emule.pdf(title- The dMule Protocol Specification) download from google. But, this spec is written in 2005. UDP just only use following types, so strip above pattern to below pattern.
# bouble- add Kad-protocol opcode that use UDP
^[\xc5\xd4\xe3-\xe5]([\x01\x02\x05\x08\x0B\x10\x11\x14\x15\x16\x18\x19\x1a\x1b\x1c\x20\x21\x30\x32\x33\x34\x35\x36\x38\x3A]|[\x40\x41\x42\x43\x46\x47\x48\x49\x4a\x4b\x4c\x4d\x4e\x4f\x50\x51\x52\x53\x54\x55\x56\x57\x58\x59\x5a\x5f]|[\x60\x61\x81\x82\x85\x86\x87\x90\x91\x92\x93\x96\x97\x98\x99\x9a\x9b\x9c\x9e\xa0\xa1\xa2\xa3\xa4])

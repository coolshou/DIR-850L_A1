...
[ ! -e "../rootfs/include/sqlite3.h" ] && MISSING="libsqlite3 $MISSING"
[ ! -e "../rootfs/include/jpeglib.h" ] && MISSING="libjpeg $MISSING"
[ ! -e "../rootfs/include/libexif/exif-loader.h" ] && MISSING="libexif $MISSING"
[ ! -e "../rootfs/include/id3tag.h" ] && MISSING="libid3tag $MISSING"
[ ! -e "../rootfs/include/ogg/ogg.h" ] && MISSING="libogg $MISSING"
[ ! -e "../rootfs/include/vorbis/codec.h" ] && MISSING="libvorbis $MISSING"
[ ! -e "../rootfs/include/FLAC/metadata.h" ] && MISSING="libflac $MISSING"
[ ! -e "../rootfs/include/ffmpeg/avutil.h" -a \
  ! -e "../rootfs/include/libavutil/avutil.h" -a \
  ! -e "../rootfs/include/ffmpeg/libavutil/avutil.h" ] && MISSING="libavutil $MISSING"
[ ! -e "../rootfs/include/ffmpeg/avformat.h" -a \
  ! -e "../rootfs/include/libavformat/avformat.h" -a \
  ! -e "../rootfs/include/ffmpeg/libavformat/avformat.h" ] && MISSING="libavformat $MISSING"
[ ! -e "../rootfs/include/ffmpeg/avcodec.h" -a \
  ! -e "../rootfs/include/libavcodec/avcodec.h" -a \
  ! -e "../rootfs/include/ffmpeg/libavcodec/avcodec.h" ] && MISSING="libavcodec $MISSING"
if [ -n "$MISSING" ]; then
...
if [ -f ../rootfs/include/iconv.h ]; then
...
if [ -f ../rootfs/include/libintl.h ]; then
